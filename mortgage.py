#!/usr/bin/python
# -*- coding: utf-8 -*-
# copy from https://github.com/jbmohler/mortgage
...
class Mortgage:
    ...
    def total_payout(self, extra_principle_payments=[]):
        ...
        return sum([p+i+e for p, i, e, _ in monthly_payments])
    ...
    def monthly_payment_schedule(self, extra_principle_payments=[]):
        ...
        while True:
            ...
            if monthly >= balance + interest:
                ...
                yield balance, interest, dollar(0), dollar(0)
                break

            principle = monthly - interest
            balance = balance - principle - extra_principle
            yield principle, interest, extra_principle, balance
